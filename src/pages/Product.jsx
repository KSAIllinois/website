...
import { PlusCircleIcon, MinusCircleIcon, ShoppingCartIcon } from '@heroicons/react/outline'
          ...
          <div className="md:flex md:items-center">
            ...
            <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
              ...
              <div className="flex items-center mt-6">
                ...
                >
                  <span className="inline-block align-middle"><ShoppingCartIcon className="h-5 w-5" /></span>
